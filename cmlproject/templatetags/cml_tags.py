...
from cmlproject.models import Topic, Tag, GlossaryTerm, MediaArtefact, MediaList
...
def get_recent_media():
    medialist = MediaList.objects.get(name__iexact="Recently Added")
    if (list):
        medias = medialist.listed_media.all()
    else:
